                ...
                <div class="container">
                    <div class="row justify-content-start">
                        <div class="col-sm-10 col-lg-8">
                            ...
                            <a href="{{ route('login') }}" class="btn text-white py-md-3 px-md-5 me-3 animated slideInLeft" style="background: #8e44ad;">Discover More</a>
                        </div>
                    </div>
                </div>
            </div>
...
<section class="py-5 bg-light">
    <div class="container text-center">
        ...
        <div class="owl-carousel category-slider">
            ...
            <div class="item p-3">
                <a href="{{ route('login') }}" class="cat-card shadow-sm">
        ...
        <div class="p-2">
            <div class="card shadow-sm border-0 text-center h-100">
                ...
                <div class="card-body">
                    ...
                    <a href="{{ route('login') }}" class="btn btn-primary w-100">Add to Cart</a>
                </div>
            </div>
        </div>
        @endforeach
...
<div class="container-fluid banner-section text-center text-white mb-5">
    <div class="py-5">
        ...
        <a href="{{ route('login') }}" class="btn btn-shop-now px-5 py-2">Shop Now</a>
    </div>
</div>
        ...
        <div class="row g-5">
            <div class="col-lg-4 col-md-6">
                ...
                <div class="d-flex flex-column justify-content-start">
                    <a class="text-white-50 mb-2 text-decoration-none" href="{{ route('login') }}"><i class="fas fa-angle-right me-2"></i>Home</a>
                    <a class="text-white-50 mb-2 text-decoration-none" href="{{ route('about') }}"><i class="fas fa-angle-right me-2"></i>About</a>
                    <a class="text-white-50 mb-2 text-decoration-none" href="{{ route('login') }}"><i class="fas fa-angle-right me-2"></i>Shop</a>
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <div class="d-flex flex-column justify-content-start">
                    ...
                    <a class="text-white-50 mb-2 text-decoration-none" href="{{ route('login') }}"><i class="fas fa-angle-right me-2"></i>Cart</a>
                    <a class="text-white-50 text-decoration-none" href="{{ route('login') }}"><i class="fas fa-angle-right me-2"></i>Orders</a>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
...
<style>
    ...
    .footer { background: #1a1e36 !important; }
    .text-white-50 { color: rgba(255, 255, 255, 0.7) !important; }
    .btn-social {
        width: 40px; height: 40px; display: flex; align-items: center; justify-content: center;
        color: white; background: #8e44ad; border-radius: 50%; text-decoration: none; transition: 0.3s;
    }
    .btn-social:hover { background: white; color: #8e44ad; }
</style>
@endsection
